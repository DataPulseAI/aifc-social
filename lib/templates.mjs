...
/* ---------- 9. GRID: the numbered one-pager infographic ----------
   ...
   Headline first, grid, then the wordmark and category at the foot. The source line
   does not belong on the card. It goes in the post body, where it can be read.
...
.pad{padding:62px 60px 48px}
h1{font-family:'Instrument Sans',sans-serif;font-weight:800;font-size:${d.size || 74}px;
  line-height:1.02;letter-spacing:-.042em;text-transform:uppercase;margin:0 0 40px}
...
.foot{display:flex;justify-content:space-between;align-items:baseline;margin-top:34px;
  padding-top:24px;border-top:1.5px solid ${C.greenPale}}
