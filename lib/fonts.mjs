...
export const FONT_CSS = [
  ...
  face('JetBrains Mono', 400, 'normal', '@fontsource/jetbrains-mono/files/jetbrains-mono-latin-400-normal.woff2'),
  face('JetBrains Mono', 500, 'normal', '@fontsource/jetbrains-mono/files/jetbrains-mono-latin-500-normal.woff2'),
].join('\n');
