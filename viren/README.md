...
Viren's personal profile, started from scratch on 21 September 2026. Separate from the page's
card system on purpose: the page is a publication, the profile is a person.

- `brand.json`: the tokens and the five rules.
