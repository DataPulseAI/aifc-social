...
| `27-the-funnel.md` | The six stages, the stage every bank row names, gate the document never the knowledge, UTM on every link, the fortnightly note, Convu as a separate funnel. |
